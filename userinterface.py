...
def getMail(s):
    ...
    # created automatically
            ...
            print Path, "this was what file i was going to open"


##################################################################JUST CHANGED STH HERE################################################################
...
def FavsWnd():
    ...
    favBox.pack()
    butn=Button(favourites,text="open",command=oFavs)
    butn.pack()
...
def openGrocery():
    ...
    Box1.pack()
    Btn2=Button(show,text="Already Bought!", command=Delgro)
    Btn2.pack()
...
def recipebox():
    ...
    delbtn=Button(openit,text="Delete recipe from the cookbook",command=delR)
...
def openingIt():
    ...
    b1=Button(openn,text="open",command=open_r)
...
def start():
    ...
    newsfeed=Label(menu,text="Newsfeed",background="bisque",fg="white",font=("helvetica",44))
    newsfeed.grid(row=6,column=1)
    
    cookbook=Button(menu,text="Main Cookbook",image=photo, command=All_recipes,background="black",fg="white",font="helvetica",height=50, width=150,compound=LEFT)
    cookbook.grid(row=0,column=4)
    Txt=Text(menu,height="20",width="50")
    Txt.grid(row=7,column=1)
    Txt.configure(background="sienna",fg="black",font="helvetica")
